...
if __name__ == '__main__':
    ...
    newmol_mw_attachment_points_loop_large(dataset_file=args.dataset_path, parent_file=args.parent_file, outfile_name=args.outfile_name, n_mol=args.n_mol, remove_hydrogens=args.remove_hydrogens, remove_hydrogens_max=args.remove_hydrogens_max, remove_hydrogens_max_n=args.remove_hydrogens_max_n, seed=args.seed, logfilename=args.logfilename, restart=args.restart)

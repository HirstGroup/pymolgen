...
def test_update_bond_frequencies():
    ...
    check = {(0, 1, 0, 0): 1, (1, 2, 2, 1): 1, (2, 3, 2, 2): 1, (3, 4, 2, 0): 1, (4, 5, 0, 1): 1, (3, 5, 2, 3): 1, (3, 6, 2, 1): 1, (6, 7, 1, 3): 1, (5, 8, 9, 0): 1, (5, 8, 11, 0): 1}
    print(bond_frequencies)
...
def test_free_valence_list():
    ...
    check = [[0], [0, 2], [1, 2], [2, 2], [0, 0], [1, 3, 9, 11], [1, 5], [3], [0], [1], [0, 2, 6, 7], [0], [4], [0, 15, 22, 26, 31, 35], [1, 1], [7, 11], [0, 0, 0], [5], [2], [1], [8], [0, 3], [1], [0, 3, 4], [3, 10, 12], [0, 3], [6, 10], [0], [5, 11], [0, 0], [0, 1, 5, 8], [0, 3, 6], [0, 7], [3], [0, 5], [8], [0, 2], [2, 9], [1, 4], [4], [5, 8]]

    assert free_valence_list_list == check
    print(free_valence_list_list)
